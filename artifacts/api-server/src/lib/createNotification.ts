...
export const NotificationType = {
  ...
  MEETING_INTERVIEW_SELECTED: "meeting_interview_selected",
  MEETING_INTERVIEW_NOT_SELECTED: "meeting_interview_not_selected",
