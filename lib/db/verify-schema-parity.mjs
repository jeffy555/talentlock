...
const COLUMN_MANIFEST = [
  ...
  {
    feature: "Discovery Meeting Outcome",
    table: "meetings",
    schemaFile: "meetings.ts",
    schemaMarkers: [
      ...
      'nextRoundTeamMemberId: integer("next_round_team_member_id")',
    ...
    dbColumns: [
      ...
      "next_round_panel_email",
      "next_round_panel_name",
      "next_round_team_member_id",
      "interview_result",
      "feedback_message_id",
    ],
  },
  {
    feature: "Discovery Meeting Outcome — candidate hiring file (F2)",
    table: "employer_candidate_notes",
    schemaFile: "employerCandidateNotes.ts",
    schemaMarkers: [
      'employerUserId: integer("employer_user_id")',
      'freelancerId: integer("freelancer_id")',
      'latestMeetingId: integer("latest_meeting_id")',
      'disposition: text("disposition")',
      'feedbackText: text("feedback_text")',
    ],
    dbColumns: [
